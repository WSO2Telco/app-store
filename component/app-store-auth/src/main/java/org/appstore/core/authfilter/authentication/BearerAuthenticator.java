 ...
 */
package org.appstore.core.authfilter.authentication;
...
public class BearerAuthenticator {
    ...
    public boolean isAuthenticatedUser(ContainerRequestContext requestContext, Method method, String
        ...
        try {
			...
			log.debug("Authentication 19 "+tokenInfo.getEndUserName());
        ...
        if (tokenInfo != null && tokenInfo.isTokenValid()) {
            ...
            try {
                ...
                log.debug("Error while retrieving tenant id for tenant domain: " + tenantDomain, e);
            }
        } else {
