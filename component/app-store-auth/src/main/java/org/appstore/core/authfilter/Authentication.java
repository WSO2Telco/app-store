 ...
 ******************************************************************************/
package org.appstore.core.authfilter;
...
import org.appstore.core.authfilter.impl.AuthenticationProsser;
import org.appstore.core.authfilter.impl.authorization.AuthorizationFilterFactory;
import org.appstore.core.authfilter.impl.authorization.BasicAuthenticationFilter;
import org.appstore.core.authfilter.impl.cookie.CookieFilterFactory;
import org.appstore.core.authfilter.util.AuthFilterParam;

@Provider
public class Authentication implements ContainerRequestFilter {

	private final Log log = LogFactory.getLog(Authentication.class);
