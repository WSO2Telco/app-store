...
export const GetAvailableApplicationAction = createAction('[App] Get Available Apps', props<{}>());
export const GetAvailableApplicationSuccessAction = createAction('[App] Get Available Apps Success ✓', props<{ payload: ApplicationListResult }>());