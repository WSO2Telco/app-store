...
import { Topic, CreateTopicParam, TopicDetail, GetTopicsParam, TopicResultPayload, PostCommentParam, PostCommentResponse } from "./forum.data.models";
...
export const PostReplySuccessAction = createAction('[Forum] Post Reply Success ✓', props<{ payload: PostCommentResponse }>());
